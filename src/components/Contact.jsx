...
export default function ContactSection() {
  return (
    <section id={SECTION_IDS.contact} className="-mt-12 sm:-mt-16 pt-4 sm:pt-6 pb-12 sm:pb-16 bg-white dark:bg-slate-900 transition-colors duration-300 overflow-hidden relative z-20">
          ...
          <div className="lg:col-span-5 space-y-4">
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="space-y-1 flex-1">
                    <p className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{SITE.address.place}</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">{SITE.address.street}</p>
            ...
            <div className="bg-slate-50/80 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-700/60 shadow-xs flex items-start gap-4 transition-all duration-300 hover:border-blue-500/40">
              ...
              <div>
                ...
                <a href={SITE.phoneHref} className="text-[11px] sm:text-xs text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  {SITE.phoneDisplay}
                </a>
              </div>
            </div>
            ...
            <div className="bg-slate-50/80 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-700/60 shadow-xs flex items-start gap-4 transition-all duration-300 hover:border-blue-500/40">
              ...
              <div className="w-full flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] sm:text-xs text-slate-600 dark:text-slate-400">{SITE.phoneDisplay}</p>
                </div>
                <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-lg bg-green-600 hover:bg-green-700 text-white text-[10px] sm:text-xs font-semibold transition-all shadow-xs">
                  Chat
                </a>
              </div>
            </div>
            ...
            <a
              href={mailtoLink("Pertanyaan Layanan Kargo Lion", "Halo Admin Lion Cargo, saya ingin bertanya mengenai...")}
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] sm:text-xs text-slate-600 dark:text-slate-400 font-medium">{SITE.email}</p>
          ...
          <div className="lg:col-span-7 h-full">
            <div className="bg-slate-50/80 dark:bg-slate-800/60 p-2 sm:p-3 rounded-3xl border border-slate-200/80 dark:border-slate-700/60 shadow-xs h-full flex flex-col">
              ...
              <div className="p-3 sm:p-4 flex items-center justify-between text-xs text-slate-600 dark:text-slate-400">
                ...
                <a href={SITE.mapsUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-semibold hover:underline">
